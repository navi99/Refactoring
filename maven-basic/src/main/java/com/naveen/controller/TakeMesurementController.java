...
public class TakeMesurementController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int stid = new StudentDAO().getStudentIdFromUsn(usn,class1,Integer.parseInt(schoolid)) ;
...
//				}
		...
		request.getRequestDispatcher("TakeMesurementForm2.jsp?msg=Mesurements Taken Successfully...&schoolid="+schoolid+"&class="+class1).forward(request, response);
